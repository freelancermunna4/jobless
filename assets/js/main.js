...
// popup_message("congratulations!", "success");
// popup_message("something was wrong!", "error");

function popup_message(data, type) {
  const popup_message = document.getElementById("popup_message");

  if (!popup_message) return;
  popup_message.style.transition = "all .5s";
