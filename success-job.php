                ...
                <div class="table">
                    <table>
                        ...
                        <tbody>
                            <?php
                             $start_page=$start*10;
                                $jobs=_getAllData($db,"SELECT * FROM `job_submit` WHERE (pubid='$ses_id' AND activity=1 OR activity=2 OR activity=3)  LIMIT $start_page,25");
                            ...
                            <tr>
                                ...
                                <td class="status">
                                    ...
                                    else if($job['activity']==2){
                                        echo '<p>Admin Riview</p>';
                                    }
                                    else{
