<?php
  ...
  $users=_getAllData($db,"SELECT * FROM lotterywinner  WHERE ativity=1 ORDER BY id DESC LIMIT $start,25");
                ...
                <div class="overflow-auto bg-white">
                    ...
                    <table class="min-w-full divide-y divide-gray-200 table-fixed">
                        <thead class="bg-white">
                            <tr>
                                <th scope="col"
                                    class="p-4 text-xs font-medium text-left text-gray-500 uppercase lg:p-5"> uname
                                </th>
                                <th scope="col"
                                ...
                                <th scope="col"
                                    class="p-4 text-xs font-medium text-left text-gray-500 uppercase lg:p-5"> Number
                                </th>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr class="hover:bg-gray-100">
                                ...
                                <td class="p-4 space-x-2 whitespace-nowrap lg:p-5">
                                    <button data-target="delete_coupon" type="button" onclick="userid(<?= $w['id'] ?>)"
                    ...
                    <div class="flex items-center justify-between border-t border-gray-200 bg-white px-4 py-3 sm:px-6">
                      ...
                      $users=_getAllData($db,"SELECT * FROM lotterywinner  WHERE ativity=1 ORDER BY id DESC");
                      echo count($users);
                    ?></span>
    ...
    <div class="relative px-4 w-full max-w-md h-full md:h-auto z-50">
        <div class="relative bg-white rounded-2xl shadow-lg">
            ...
            <div class="p-6 pt-0 text-center text-5xl text-red-500"> <i class="fa-solid fa-circle-exclamation"></i>
                <h3 class="my-9 text-base font-normal text-gray-500">Want to Delete Lottery Winner?
                </h3>
