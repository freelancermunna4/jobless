...
$uid=$data['id'];
  $jobs=_getAllData($db,"SELECT * FROM job_system WHERE activity=1 ORDER BY id DESC LIMIT $start,25");
                            ...
                            <tr class="hover:bg-gray-100">
                                ...
                                <td class="p-4 space-x-2 whitespace-nowrap lg:p-5">
                                    <a target="_blank" href="<?= $r['oldUrl'] ?>"
                                        class="text-blue-600 hover:underline"><?= substr($r['web_link'], 0, 25); ?>...
                                    </a>
                                </td>
                        ...
                        <div
                            ...
                            <div class="w-fit">
                                <p class="text-sm text-gray-700">
                                    ...
                                    $jobs=_getAllData($db,"SELECT * FROM job_system WHERE activity=1 ORDER BY id DESC");
                                    echo count($jobs);
                                     ?></span>
