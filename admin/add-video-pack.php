...
$err="";
  if(isset($_POST['submit'])){
    ...
    $insert=_insertData($db,"INSERT INTO `vad_packs`(`name`, `coins`, `time`, `activity`) VALUES ('$pname',' $coin','$tim','1')");
    if($insert){
      $err= "Success";
    }else{
      $err="Something Wrong";
      ...
      <div class="x_container space-y-10 py-10">
        <form class="grid grid-cols-2 gap-y-8 gap-x-12" action="" method="POST">
          ...
          <div class="col-span-2 lg:col-span-1 flex flex-col gap-y-1">
            ...
            <input  name="tim"  class="input" type="text" id="Time" placeholder="20" required>
          </div>
