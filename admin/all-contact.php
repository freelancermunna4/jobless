...
$uid=$data['id'];
  $wbpac=_getAllData($db,"SELECT * FROM contactpage WHERE riply=0  ORDER BY id ASC LIMIT $start,25");
  $totaluser=count($wbpac);
                ...
                <table class="min-w-full divide-y divide-gray-200 table-fixed">
                  <thead class="bg-white">
                    ...
                    <th scope="col" class="p-4 text-xs font-medium text-left text-gray-500 uppercase lg:p-5"> Name </th>
                      <th scope="col" class="p-4 text-xs font-medium text-left text-gray-500 uppercase lg:p-5"> Email </th>
                       <th scope="col" class="p-4 text-xs font-medium text-left text-gray-500 uppercase lg:p-5"> Messege </th>
                  ...
                  <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <td class="p-4 text-sm font-normal text-gray-500 whitespace-nowrap lg:p-5">
                      ...
                      <td class="p-4 text-sm font-normal text-gray-500 whitespace-nowrap lg:p-5">
                      <?= date('d-M-Y',$p['time']) ?></td>
                      <td class="p-4 space-x-2 whitespace-nowrap lg:p-5">
                        <a href="./reply-contact.php?id=<?= $p['id'] ?>" type="button"
                          class="btn bg-green-600 w-fit text-white">Repley</a>
