...
$uid=$data['id'];
  $videopc=_getAllData($db,"SELECT * FROM youtube_sub_packs WHERE activity=1 ORDER BY id ASC LIMIT $start,25");
                    ...
                    foreach($videopc as $p){ ?>
                            ...
                            <tr class="hover:bg-gray-100">
                                ...
                                <td class="p-4 space-x-2 whitespace-nowrap lg:p-5">
                                    <a href="./edit-subscribe-pack.php?id=<?=$p['id'] ?>" type="button"
                        ...
                        <div
                            ...
                            <div class="w-fit">
                                <p class="text-sm text-gray-700">
                                    ...
                                    $videopc=_getAllData($db,"SELECT * FROM youtube_sub_packs WHERE activity=1 ORDER BY id ASC");
                                    echo count($videopc);
                                    ?></span>
