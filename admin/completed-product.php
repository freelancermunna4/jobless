                ...
                <form action="" method="GET">
                    ...
                    <table class="min-w-full divide-y divide-gray-200 table-fixed">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                if(isset($_GET['src'])){
                                    $src = trim($_GET['src']);
                                    $products = $db->Query("SELECT product_system.*,users.* FROM product_system INNER JOIN users ON product_system.uid = users.id WHERE product_system.activity=1 AND product_system.conditions='Completed' AND ( users.fullname = '$src' OR users.email = '$src' OR product_system.product_title = '$src' OR product_system.amount = '$src' OR product_system.category = '$src' OR product_system.status = '$src' )");
                                }else{
                            ...
                            <tr class="hover:bg-gray-100">
                                ...
                                <td class="p-4 text-sm font-normal text-gray-500 text-center whitespace-nowrap lg:p-5">
                                    ...
                                    <a class="list_btn" style="background:#EF4444;" href="delete.php?src=completed-product&&id=<?php echo $product['id'];?>">Delete</a>
