            ...
            <div class="inline-block min-w-full align-middle">
              <div class="overflow-auto bg-white">
                  <div style="text-align: right;margin: 5px;padding-top: 10px;">
                        <input type="text" id="srcvalue" placeholder="Username / Mobile No"
                ...
                <table class="min-w-full divide-y divide-gray-200 table-fixed">
                  <thead class="bg-white">
                    <tr>
                      ...
                      <th scope="col" class="p-4 text-xs font-medium text-left text-gray-500 uppercase lg:p-5"> Account
                      </th>
                  ...
                  <?php
                  $deposit=_getAllData($db,"SELECT * FROM `withdrawals` WHERE status=0 ORDER BY id ASC LIMIT 50");
                  if($deposit !=0){
      ...
      <div class="relative bg-white rounded-2xl shadow-lg">
        ...
        <div class="p-6 pt-0 text-center text-5xl text-green-600"> <i class="fa-solid fa-circle-exclamation"></i>
          ...
          <div class="w-full flex justify-between items-center gap-x-2"><a href="#" data-target="approve_request"
            ...
            <button id="waprove"
              class="disabled:opacity-70 disabled:cursor-not-allowed text-white bg-green-600 font-medium rounded-lg text-sm inline-flex items-center px-3 py-2.5 text-center mr-2 shadow-md shadow-gray-300 hover:scale-[1.02] transition-transform"><span>Yes,
                Approve</span></button>
          </div>
        </div>
      </div>
    ...
    <div class="relative px-4 w-full max-w-md h-full md:h-auto z-50">
      <div class="relative bg-white rounded-2xl shadow-lg">
        ...
        <div class="p-6 pt-0 text-center text-5xl text-red-500"> <i class="fa-solid fa-circle-exclamation"></i>
          <h3 class="my-9 text-base font-normal text-gray-500">Want to reject?
          </h3>
