...
$uid=$data['id'];
  $wbpac=_getAllData($db,"SELECT * FROM web_surfing_pckks WHERE activity=1  ORDER BY id ASC LIMIT $start,25");
...
<div class="x_container space-y-10 py-10">
    ...
    <div class="flex flex-col rounded-lg shadow-md border border-[
                ...
                <div class="overflow-auto bg-white">
                        ...
                        <thead class="bg-white">
                            <tr>
                                ...
                                <th scope="col"
                                    ...
                                    Name </th>
                                <th scope="col"
                                    class="p-4 text-xs font-medium text-left text-gray-500 uppercase lg:p-5"> Click
                                    Price </th>
                    ...
                    foreach($wbpac as $p){ ?>
                            ...
                            <tr class="hover:bg-gray-100">
                                ...
                                <td class="p-4 text-sm font-normal text-gray-500 whitespace-nowrap lg:p-5">
                                    <?= $p['name'] ?> </td>
                                <td class="p-4 text-sm font-normal text-gray-500 whitespace-nowrap lg:p-5"> 0.
                                    <?= $p['coins'] ?> Coin </td>

                                <td class="p-4 text-sm font-normal text-gray-500 whitespace-nowrap lg:p-5">
                                    <?= $p['time'] ?> seconds </td>
                                <td class="p-4 space-x-2 whitespace-nowrap lg:p-5">
                                    <a href="./edit-website-pack.php?id=<?= $p['id'] ?>" type="button"
                                        class="btn bg-green-600 w-fit text-white">Edit</a>
                                    <button onclick="deleteid(<?= $p['id'] ?>)" data-target="delete_pack" type="button"
                        ...
                        <div
                            ...
                            <div class="w-fit">
                                <p class="text-sm text-gray-700">
                                    ...
                                    $wbpac=_getAllData($db,"SELECT * FROM web_surfing_pckks WHERE activity=1  ORDER BY id ASC");
                                    echo count($wbpac);
                                     ?></span>
                            ...
                            <div class="w-fit">
                                <nav class="isolate inline-flex -space-x-px rounded-md shadow-sm"
                                    ...
                                    <a href="add-website-packs?strt=<?php
      if($start>24){
        echo $start-25;
      }else{
        echo 0;
      ...
      " class="relative inline-flex items-center rounded-l-md border border-gray-300 bg-white px-2 py-2 text-sm font-medium text-gray-500 hover:bg-gray-50 focus:z-20">
                                    ...
                                    <a href="add-website-packs?strt=<?php if($totaluser>$start){ echo ($start+25);
      }else{
        echo $start;
