                ...
                <div class="overflow-auto bg-white">
                    ...
                    <table class="min-w-full divide-y divide-gray-200 table-fixed">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                $products=_getAllData($db,"SELECT * FROM product_system WHERE activity=1 AND conditions = 'Running' ORDER BY id DESC LIMIT $offset, $total_records_per_page");
                            ...
                            <tr class="hover:bg-gray-100">
                                ...
                                <td class="p-4 text-sm font-normal text-red-500 whitespace-nowrap text-center lg:p-5"><b><?php echo $product['conditions']?></b></td>
                                <td class="p-4 text-sm font-normal text-gray-500 text-center whitespace-nowrap lg:p-5">
                                    <a class="list_btn" style="background:#EF4444;" href="product-conditions.php?id=<?php echo $product['id'];?>">Edit</a>
                                    <a class="list_btn" style="background:#EF4444;" href="delete.php?src=running-product&&id=<?php echo $product['id'];?>">Delete</a>
