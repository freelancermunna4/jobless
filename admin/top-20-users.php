...
require_once"common/header.php";
  $users=_getAllData($db,"SELECT * FROM users WHERE admin=0 AND disabled=0 ORDER BY coins DESC LIMIT 20");
                ...
                <table class="min-w-full divide-y divide-gray-200 table-fixed">
                  <thead class="bg-white">
                    <tr>
                      ...
                      <th scope="col" class="p-4 text-xs font-medium text-left text-gray-500 uppercase lg:p-5"> Type
                      </th>
                  ...
                  <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-100">
                      ...
                      <td class="p-4 text-sm font-normal text-gray-500 whitespace-nowrap lg:p-5">
                      <?= $us['email'] ?> </td>
                      <td class="p-4 text-sm font-normal text-gray-500 whitespace-nowrap lg:p-5"> Bangladesh </td>
                      <td class="p-4 text-sm font-normal text-gray-500 whitespace-nowrap lg:p-5">
                        <?= $us['coins'] ?> </td>
                      <td class="p-4 text-sm font-normal text-gray-500 whitespace-nowrap lg:p-5">
                        <?php
                        $type=$us['coins'];
                        if($type==2){echo "Moderator";}else{echo "User";}
                        ?> </td>
                      <td class="p-4 space-x-2 whitespace-nowrap lg:p-5">
                        <a href="./edit-user.php?is=<?= $us['id'] ?>" type="button" class="btn bg-green-600 w-fit text-white">Edit</a>
                        <button onclick="userid(<?= $us['id']  ?>)" data-target="delete_user" type="button"
